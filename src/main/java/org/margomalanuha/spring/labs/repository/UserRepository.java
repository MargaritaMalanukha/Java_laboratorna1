...
public class UserRepository extends Repository {
    ...
    public int update(User user) {
        String sql = "update users set name=" + user.getName() + ", surname=" + user.getSurname() + ", email=" + user.getEmail() + ", password=" +
                user.getPassword() + ", user_type_id=" + user.getUserTypeId() + ", is_active=" + user.isActive() + " where id=" + user.getId() + ";";
        return jdbcTemplate.update(sql);
    }
